    ...
    def convert(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            with pdfplumber.open(pdf_bytes, **open_kwargs) as pdf:
            ...
            if form_page_count == 0:
                pdf_bytes.seek(0)
                extract_kwargs = {"password": password} if password else {}
                markdown = pdfminer.high_level.extract_text(pdf_bytes, **extract_kwargs)
            else:
